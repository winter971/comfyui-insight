...
- **第四部分 · 真实工作流库** — 从 Civitai 公开抓取并解析的真实社区工作流（2281 条 + 2991 份交互节点图）：多维表格视图支持按作者 / 类别 / 底模等任意列筛选、排序与分组聚合；详情页含节点构成、需装节点包、模型依赖与 AI 深度讲解（渐进覆盖中，含管线阶段拆解与图内高亮联动）；另有**专题层**，把模型家族 / 一类玩法（如视频生成、MiniMax-H3）单独拎出来做对比表、子主题分组与规格速查
