...
- **待办**：AI 精读按新 schema 继续磨（当前 aiDone = 2146，完成率 92.02%，剩余 186 条；最近一轮新增 62 篇；最新版本 20260925m，**仅本地提交，未推送**）；工作流 graph 节点的 params 逐条增强（当前靠 widget-help.js 自动推导）；详情页 390px 横向溢出未修（原版就有，见 [docs/themes.md](../docs/themes.md) 末节）。
