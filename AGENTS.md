...
- **待办**：AI 精读按新 schema 继续磨（发布节奏每满 60 份一发布点，下一发布点 558）；工作流 graph 节点的 params 逐条增强（当前靠 widget-help.js 自动推导）；详情页 390px 横向溢出未修（原版就有，见 [docs/themes.md](../docs/themes.md) 末节）。
