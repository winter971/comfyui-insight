...
- **待办**：AI 精读按新 schema 继续磨（当前 aiDone = 2009，完成率 86.15%，剩余 323 条；最近一轮新增 4 篇；最新版本 20260925j，**仅本地提交，未推送**）；工作流 graph 节点的 params 逐条增强（当前靠 widget-help.js 自动推导）；详情页 390px 横向溢出未修（原版就有，见 [docs/themes.md](../docs/themes.md) 末节）。
