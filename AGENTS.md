...
- **待办**：AI 精读按新 schema 继续磨（当前 aiDone = 1092，本轮完成 Batch 20 & 21 累计新增 16 篇；最新版本 20260924e，已推送 main）；工作流 graph 节点的 params 逐条增强（当前靠 widget-help.js 自动推导）；详情页 390px 横向溢出未修（原版就有，见 [docs/themes.md](../docs/themes.md) 末节）。
